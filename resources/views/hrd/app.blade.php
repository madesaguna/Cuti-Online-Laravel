...
<head>
    ...
    <link href="{{asset('/template/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css')}}"
          rel="stylesheet">
    ...
    <link href="{{asset('/template/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}"
          rel="stylesheet">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="{{url('/hrd')}}"><i class="fa fa-home"></i> Approval </a></li>
                            <li><a href="{{url('/holiday')}}"><i class="fa fa-home"></i> Daftar Hari Libur </a></li>
